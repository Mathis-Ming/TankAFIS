...
void resetJetonNonLu(int currentCase)
{
  railSpeed = 130;
  Serial.println("Retour à la maison");
  switch (currentCase) {
...
void VerificationExistenceEtatActuel(const char* etatCourant){
  if(etatActuel!=""){
    ...
    if(erreur==true){
      ...
      Serial.println("L n'existe pas dans la table des instructions");   
      arretRobot();
    }
  }
}
